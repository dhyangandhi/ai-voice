...
-- CreateEnum
CREATE TYPE "VoiceCategory" AS ENUM ('AUDIOBOOK', 'CONVERSTONAL', 'GENERAL', 'CUSTOMER_SERVICE', 'NARRATIVE', 'CHARACTERS', 'MEDITATION', 'MOTIVATION', 'PODCAST', 'ADVERTISING', 'VOICEOVER', 'CORPORATE');
